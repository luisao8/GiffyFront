...
function Footer() {
  ...
  return (
    <footer class="py-10 bg-gray-50 sm:pt-16 lg:pt-24 fixed bottom-0 w-full">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src={logo} alt="" />

                <p class="text-base leading-relaxed text-gray-600 mt-7">Discover the best GIF's on the internet and add to our growing community.</p>
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Subscribe for top monthly GIF's</p>
